...
# TanStack Start Serverless

> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-tanstack-start-serverless)

- [TanStack Start](https://tanstack.com/start) app deployed serverlessly via the
  [tanstack-web resource](https://docs.stacktape.com/compute-resources/tanstack-web/) — Lambda + S3 + CloudFront CDN.
- Server-side rendered with full-stack type safety. Pay only for traffic you serve.
...
```bash
stacktape init --starterId tanstack-start-serverless
```
...
The `tanstack-web` resource handles everything automatically:
